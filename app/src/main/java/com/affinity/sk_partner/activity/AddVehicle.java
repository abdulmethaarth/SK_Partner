...
import com.affinity.sk_partner.CabType;
import com.affinity.sk_partner.CabTypes_list;
import com.affinity.sk_partner.CabsTypeAdapter;
        ...
        call.enqueue(new Callback<CreateResponse>() {
            ...
            public void onResponse(Call<CreateResponse> call, Response<CreateResponse> response) {
                ...
                if (users.status.equalsIgnoreCase("true")) {
                    ...
                    editor.apply();
                    startActivity(new Intent(AddVehicle.this, AddPersonalDocs.class));
                    finish();
