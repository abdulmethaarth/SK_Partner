...
public class CreateProfile extends AppCompatActivity {
    ...
    Button crt_prof_nxt;
    EditText edit_fname, edit_lname, edit_email, edit_password,edit_pan_no, edit_mobile, edit_license_no;
    private ProgressDialog pDialog;
    RadioGroup radioGroup;
    RadioButton male,female;
    Api myApi;
    RelativeLayout layout_back_arrow;
    TextView already_login,edit_dob,issue_date,exp_Date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // edit_password = (EditText) findViewById(R.id.password);
        ...
        edit_pan_no = (EditText) findViewById(R.id.pan_no);
        edit_license_no = (EditText) findViewById(R.id.license_no);
        ...
        crt_prof_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 if (edit_fname.getText().toString().isEmpty()) {
                    Snackbar.make(findViewById(android.R.id.content), "Please enter full name", Snackbar.LENGTH_LONG).show();
                    return;
                    ...
                    return;
                }*/else if (edit_pan_no.getText().toString().isEmpty()) {
                    Snackbar.make(findViewById(android.R.id.content), "Please enter PAN no", Snackbar.LENGTH_LONG).show();
                    return;
                    ...
                    Snackbar.make(findViewById(android.R.id.content), "Please enter License issue date", Snackbar.LENGTH_LONG).show();
                    return;
                }else if (exp_Date.getText().toString().isEmpty()) {
                    Snackbar.make(findViewById(android.R.id.content), "Please enter Licence Exp date", Snackbar.LENGTH_LONG).show();
                    return;
    ...
    private void createProfile() {
        String fullname  = edit_fname.getText().toString();
        String email_id = edit_email.getText().toString();
        String panNo = edit_pan_no.getText().toString();
        String mobileno = edit_mobile.getText().toString();
        String issueDate = issue_date.getText().toString();
        String expiryDate = exp_Date.getText().toString();
        String licenceNO = edit_license_no.getText().toString();
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            Intent datas = new Intent(CreateProfile.this,AddPersonalDocs.class);
            datas.putExtra("fullname",fullname);
            datas.putExtra("email_id",email_id);
            datas.putExtra("panNo",panNo);
            datas.putExtra("mobileno",mobileno);
            datas.putExtra("issueDate",issueDate);
            datas.putExtra("expiryDate",expiryDate);
            datas.putExtra("licenceNO",licenceNO);
            datas.putExtra("gender",gender);
            datas.putExtra("dob",dob);
            startActivity(datas);
